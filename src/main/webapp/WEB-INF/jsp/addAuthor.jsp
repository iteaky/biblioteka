...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <!DOCTYPE html>
<head>
<form action="/biblioteka/AddAuthor">
<style>
    * {
...
<div class="container">
    <form action="/action_page.php">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="lname" name="secondName" placeholder="again?"></input>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input type="text" id="lname" name="birthday" placeholder="DD-MM-YYYY"></input>
            </div>
        </div>
